            ...
            <BarChart data={campaignData} margin={{ top: 20, right: 30, left: 0, bottom: 20 }}>
              <defs>
                <linearGradient id="colorDonations" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#3b8" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="#3c6" stopOpacity={0.1} />
                </linearGradient>
                <linearGradient id="colorDonors" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#3b9" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="#4b8" stopOpacity={0.1} />
                </linearGradient>
              </defs>
