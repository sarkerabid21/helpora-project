  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-200 dark:bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-indigo-200 dark:bg-emerald-900 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative z-10">
        ...
        <header className="pt-12 pb-8 px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="mb-6">
              <span className="text-sm font-semibold text-emerald-600 dark:text-blue-400 uppercase tracking-wider">
        ...
        <main className="px-4 sm:px-6 lg:px-8 pb-16">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            {/* CTA Section */}
            <div
              className={`bg-gradient-to-r from-green-600 to-indigo-600 dark:from-blue-700 dark:to-indigo-700 rounded-2xl p-8 sm:p-12 text-white shadow-xl transition-all duration-1000 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
              style={{ transitionDelay: "500ms" }}
            >
              <div className="flex flex-col bg-emerald-600 sm:flex-row items-start sm:items-center justify-between gap-6">
                <div>
